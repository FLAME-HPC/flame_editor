...
CEGraphicsItem::CEGraphicsItem(CEItemType ItemType, QString n, QGraphicsItem *parent, QGraphicsScene *scene)
...
CEGraphicsItem::~CEGraphicsItem()
{
}

void CEGraphicsItem::changeCondition(CEItemType item)
{
...
QString CEGraphicsItem::getName() {
    return name;
}

void CEGraphicsItem::setName(QString n) {
...
void CEGraphicsItem::setState(QString name) {
    mytype = State;
    setName(name);
}

void CEGraphicsItem::setTransition(QString name) {
    mytype = Transition;
    setName(name);
}

void CEGraphicsItem::setMessage(QString name) {
    mytype = Message;
    setName(name);
}

void CEGraphicsItem::setDiamond(QString name)
{
    mytype = ConditionIf;
    setName(name);
}

void CEGraphicsItem::setBoundingRect() {
 ...
 */
QRectF CEGraphicsItem::boundingRect() const {
    qreal adjust = 0.5;
 ...
 *  \return The shape.
 */
QPainterPath CEGraphicsItem::shape() const {
    QPainterPath path;
...
int CEGraphicsItem::width() {
    return myBoundingRect.width();
}

void CEGraphicsItem::paint(QPainter *painter, const QStyleOptionGraphicsItem *,
        QWidget *) {
    /* Set paint options */
