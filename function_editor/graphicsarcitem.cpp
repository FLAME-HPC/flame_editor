...
GraphicsArcItem::GraphicsArcItem(QPointF p1, QPointF p2, QGraphicsItem *parent) :
...
double GraphicsArcItem::Angle(QPointF o, QPointF p)
{
    float x1, x2, y1, y2;
    x1 = o.x();
    y1 = o.y();
...
double GraphicsArcItem::Distance(QPointF p1, QPointF p2)
{
    return ::sqrt((p2.x() - p1.x()) * (p2.x() - p1.x()) + (p2.y() - p1.y()) * (p2.y() - p1.y()));
}

QPointF GraphicsArcItem::PointOnArc(QRectF rectangleF, double angle)
{
