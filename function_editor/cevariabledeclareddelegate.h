#ifndef CEVARIABLEDECLAREDDELEGATE_H
#define CEVARIABLEDECLAREDDELEGATE_H
...
class CEVariableDeclaredDelegate : public QItemDelegate
{
    Q_OBJECT

public:
    CEVariableDeclaredDelegate(QObject *parent = 0);
