 ...
 */
CEArrow::CEArrow(CEGraphicsItem *startItem, CEGraphicsItem *endItem,
...
void CEArrow::setName(QString n)
{
    name = n;
    /* Use font metrics */
...
QRectF CEArrow::setBoundingRect()
{
...
QRectF CEArrow::boundingRect() const{
...
QPainterPath CEArrow::shape() const {
...
void CEArrow::paint(QPainter *painter, const QStyleOptionGraphicsItem *,
          QWidget *) {
