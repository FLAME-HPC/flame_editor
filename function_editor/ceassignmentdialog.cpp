...
CEAssignmentDialog::CEAssignmentDialog(QWidget *parent) :
    QDialog(parent)
{
...
QAbstractItemModel *CEAssignmentDialog::modelFromFileList(const QString &fileName)
{
    QFile file(fileName);
...
QAbstractItemModel *CEAssignmentDialog::modelFromFileTree(const QString &fileName)
{
    QFile file(fileName);
    if (!file.open(QFile::ReadOnly))
        return new QStringListModel(completer);
...
void CEAssignmentDialog::ok_click()
{
...
void CEAssignmentDialog::cancel_click()
{
    reject();
}

CEAssignmentDialog::~CEAssignmentDialog()
{
    delete lAssignment;
    delete pbOk;
    delete pbCancel;
